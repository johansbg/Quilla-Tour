...
function SectionOneComponent(props) {
    ...
    return (
        ...
        <Row className="centerText2 mobileReduccionThree">
            <Col xs={6} md={2}>
                <div className="img1 d-none d-sm-block">
                </div>
            </Col>
            <Col xs={6} md={2}>
                <div className="img2">
            ...
            <Col xs={12} md={2}>
                <div className="img3 d-none d-sm-block">
                </div>
            </Col>
            <Col xs={12} md={2}>
                <div className="img4 d-none d-sm-block">
                </div>
            </Col>
            <Col xs={12} md={2}>
                <div className="img5 d-none d-sm-block">
                </div>
            </Col>
        </Row>
        <Row>
            <Col xs={12}>
                <div className="centerText mobileReduccionThree">
                    <span className="bgNumber">
                        {day.charAt(0)}
                    </span>
                    <span className="bgNumber marginR">
                        {day.charAt(1)} 
                    </span>
                    <span className="bgNumber marginR">
                        -
